...
def open_image():
    ...
    set_image_file(askopenfilename(filetypes=(("Image Files", "*.jpg *.JPG *.JPEG *.jpeg *.png"),)))
...
def generate_ui():
    ...
    convert_button = Button(frame2, text="Generate Histogram", command=generate_histogram, width=22)
    convert_button.pack()
